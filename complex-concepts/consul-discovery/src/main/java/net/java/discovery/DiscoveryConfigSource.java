...
public class DiscoveryConfigSource implements ConfigSource {
            ...
            if (serviceNameAndProp.length == 4) {
                ...
                if (serviceProp.equals("url")) {
                    ...
                    if (!services.isEmpty()) {
                        ...
                        String contextRoot = selectedService.getMeta().getOrDefault("contextRoot", "");
    ...
    public String getName() {
        return DiscoveryConfigSource.class.getSimpleName();
    }
